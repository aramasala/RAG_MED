...
def generate(
    ...
    eval_summary: str = typer.Option(None, "--eval-summary", help="Evaluation summary file"),
    verbose: bool = typer.Option(False, "--verbose", "-v", help="Verbose output"),
) -> None:
    ...
    """
    # DEBUG
    print(f"🔍 DEBUG - valueai_eval from CLI: {valueai_eval}")
    print(f"🔍 DEBUG - Type of valueai_eval: {type(valueai_eval)}")
